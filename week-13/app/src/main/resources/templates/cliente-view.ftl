                ...
                <#else>
                    <form method="post" action="/cliente/criar">
                        ...
                        <div class="form-group">
                            ...
                            <input value="${(clienteAtual.idade)!}" name="nome" type="text" class="form-control" id="nome">
                        </div>

                        <div class="form-group">
                            <label for="nome">Telefone:</label>
                            <input value="${(clienteAtual.telefone)!}" name="nome" type="text" class="form-control" id="nome">
                        </div>
